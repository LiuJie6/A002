...
public class Activity10 extends Activity implements RadioGroup.OnCheckedChangeListener {
    int flag = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        display = (Button) findViewById(R.id.btn10);
    }
    ...
    public void onCheckedChanged(RadioGroup arg0, int arg1) {
        switch (arg1) {
            ...
            case R.id.radio2:
                flag = 1;
                Toast.makeText(getBaseContext(), "Just a little", Toast.LENGTH_SHORT)
                        .show();
                display.setText("Next");
                break;
            default:
